<?php
add_action('admin_menu', 'pro_register_wpsisac_slider_submenu_page');
function pro_register_wpsisac_slider_submenu_page() {
	add_submenu_page( 'edit.php?post_type=slick_slider', 'Pro Slider Designs', 'Pro Slider Designs', 'manage_options', 'wpsisac_slider-submenu-page', 'pro_register_wpsisac_slider_page_callback' );

}
function pro_register_wpsisac_slider_page_callback() {

	$result ='<div class="wrap"><div id="icon-tools" class="icon32"></div><h2 style="padding:15px 0">Pro WP Slick Slider Designs</h2></div>
 ...
 dots="true" arrows="true" autoplay="true" sliderheight="400" autoplay_interval="5000" speed="1000" effect="false" loop="true"]</code></p></div>
				...
				<div class="medium-12 wpcolumns"><h3>Complete shortcode for Carousel Slider:</h3><p><code>[slick-carousel-slider  design="prodesign-11" category="8" limit="5"
...
function pro_register_wpsisac_slider_admin_style(){
	?>
	<style type="text/css">
...
add_action('admin_head', 'pro_register_wpsisac_slider_admin_style');